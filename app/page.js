  ...
  return (
    <Layout home>
      ...
      <div className={`min-h-screen ${darkMode ? 'dark' : ''}`}>
        ...
        <div className={`max-w font-sans ${darkMode ? 'bg-darkest text-white' : 'bg-lightest text-darkest'} block flex-grow justify-center pt-[80px] px-4 sm:px-6 lg:px-8 transition-colors duration-300`}>
          ...
          <div className="flex justify-center my-2 pb-[100px]">
            <div className="flex-shrink text-base sm:text-lg w-full max-w-3xl">
